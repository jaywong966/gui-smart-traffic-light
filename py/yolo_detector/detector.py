...
from yolo_detector.utils.utils import *
from detection_roi.roi import roi_postprocessing
...
class yolo_detector:
    ...
    def detect(self):
        ...
        for sources, imgs_to_model, imgs_to_show, vid_cap in frames:
            ...
            if view_img:
                [display_image(source, im0_detection) for source, im0_detection in zip(sources, im0s_detection)]
