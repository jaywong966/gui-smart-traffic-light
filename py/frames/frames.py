...
import numpy as np
import json
from detection_roi.roi import load_roi_config ,roi_preprocessing , draw_roi
...
class LoadStreams:  # multiple IP or RTSP cameras
    ...
    def __next__(self):
        ...
        if self.preprocessing_flag:
            imgs_to_model = roi_preprocessing(imgs_to_model, self.roi_list)
        # Stack
